...
- WhatsApp: por padrão, o site abre o seletor do WhatsApp. Para enviar direto a um número, substitua `https://wa.me/?text=` por `https://wa.me/55DDDNUMERO?text=` em `app.js`.
